...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.source'
        db.add_column(u'books_book', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Book.remote_id'
        db.add_column(u'books_book', 'remote_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.source'
        db.delete_column(u'books_book', 'source')

        # Deleting field 'Book.remote_id'
        db.delete_column(u'books_book', 'remote_id')
