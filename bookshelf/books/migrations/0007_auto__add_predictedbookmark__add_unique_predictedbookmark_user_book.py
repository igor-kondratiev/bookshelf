...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PredictedBookMark'
        db.create_table(u'books_predictedbookmark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Book'])),
            ('mark', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'books', ['PredictedBookMark'])

        # Adding unique constraint on 'PredictedBookMark', fields ['user', 'book']
        db.create_unique(u'books_predictedbookmark', ['user_id', 'book_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PredictedBookMark', fields ['user', 'book']
        db.delete_unique(u'books_predictedbookmark', ['user_id', 'book_id'])

        # Deleting model 'PredictedBookMark'
        db.delete_table(u'books_predictedbookmark')
    ...
    models = {
        ...
        u'books.predictedbookmark': {
            'Meta': {'unique_together': "(['user', 'book'],)", 'object_name': 'PredictedBookMark'},
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['books.Book']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mark': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
