...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'books_bookmark', (
        ...
        db.send_create_signal(u'books', ['BookMark'])

        # Adding unique constraint on 'BookMark', fields ['user', 'book']
        db.create_unique(u'books_bookmark', ['user_id', 'book_id'])

        # Adding unique constraint on 'BookDistance', fields ['first_book', 'second_book']
        db.create_unique(u'books_bookdistance', ['first_book_id', 'second_book_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BookDistance', fields ['first_book', 'second_book']
        db.delete_unique(u'books_bookdistance', ['first_book_id', 'second_book_id'])

        # Removing unique constraint on 'BookMark', fields ['user', 'book']
        db.delete_unique(u'books_bookmark', ['user_id', 'book_id'])

        # Deleting model 'BookMark'
        db.delete_table(u'books_bookmark')
    ...
    models = {
        ...
        u'books.book': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        u'books.bookdistance': {
            'Meta': {'unique_together': "(['first_book', 'second_book'],)", 'object_name': 'BookDistance'},
        ...
        u'books.bookmark': {
            'Meta': {'unique_together': "(['user', 'book'],)", 'object_name': 'BookMark'},
